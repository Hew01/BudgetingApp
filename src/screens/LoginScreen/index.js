...
export default function LoginScreen({navigation}) {
    ...
    return <Center flex={1}>
        <Text  fontSize={22} marginBottom={'10'} fontWeight={'medium'}>Đăng nhập</Text>
        ...
        <Input width={'300'} height={'10'} fontSize={'16'} variant="underlined" placeholder="Mật khẩu" 
            _light={{
            placeholderTextColor: "blueGray.400"
            }} _dark={{
            placeholderTextColor: "blueGray.50"
        ...
        <Text  onPress={forgetPassword} fontSize={12} marginTop={2} fontStyle={'italic'} alignSelf={'flex-end'} marginRight={10} fontWeight={'light'}>Quên mật khẩu ?</Text>
        <Button fontSize={'16'} margin={'10'} borderRadius={'30'} width={'300'}>ĐĂNG NHẬP</Button>
        <View marginBottom={10} flexDirection={'row'}>
            <Text>Chưa có tài khoản ?  </Text>
            <Text color={'darkBlue.500'}  onPress={()=>navigation.navigate('signup')} >Đăng kí ngay  </Text>
        </View>
